...
start_preamble = 32;
preamble = sign(Rx_signal_match(start_preamble:mp:56*mp+31));
preamble = (preamble + 1)/2
preamble'

start_sfd = 56*mp + 32;
sfd = sign(Rx_signal_match(start_sfd:mp:56*mp+31+8*mp));
sfd = (sfd + 1)/2
sfd'

start_sda = start_sfd +8*mp;
dsa = sign(Rx_signal_match(start_sda:mp:56*mp+31+8*mp+280*mp));
dsa = (dsa + 1)/2
dsa'
